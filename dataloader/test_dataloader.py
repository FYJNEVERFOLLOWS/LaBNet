...
class TFDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        all_sources, doa_as_array, target_1, target_2, angle_list, wave_paths, doa_idx_array, xy_coordinates = self.get_mixture_and_gt(metadata)
        ...
        angular_distance = abs(angle_list[0]-angle_list[1])
        social_distance = float(metadata["social_dist"])
    ...
    def get_mixture_and_gt(self, metadata):
        dataset_prefix = "/local01/fuyanjie"
        ...
        #             temp_as_1 = copy.deepcopy(as_dict[0])
        #             temp_as_2 = copy.deepcopy(as_dict[1])
        ...
        return all_sources, doa_as_array, target_data_1, target_data_2, angle_list, wave_paths, doa_idx_array, xy_coordinates
...
if __name__ == "__main__":
    ...
    data_loader = static_loader(lst_path, shuffle=False)
